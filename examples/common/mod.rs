...
const HTTP_PORT: u16 = kodegen_config::PORT_CITESCRAPE - 10000;
...
const HTTP_URL: &str = const_format::formatcp!("http://127.0.0.1:{}/mcp", kodegen_config::PORT_CITESCRAPE - 10000);
