...
//! - Widget sections (social, cookie notices, ads) - filtered out
//! - Generic section elements treated as block elements
...
pub(super) fn section_handler(handlers: &dyn Handlers, element: Element) -> Option<HandlerResult> {
